...
- (void)loadView
{
    ...
    gradientLayer.colors = @[
        (__bridge id)[UIColor colorWithRed:0.1f green:0.1f blue:0.2f alpha:1.0f].CGColor,
        (__bridge id)[UIColor colorWithRed:0.0f green:0.1f blue:0.3f alpha:1.0f].CGColor,
        (__bridge id)[UIColor colorWithRed:0.2f green:0.1f blue:0.1f alpha:1.0f].CGColor,
        (__bridge id)[UIColor colorWithRed:0.3f green:0.2f blue:0.1f alpha:1.0f].CGColor
    ];
    ...
    colorAnimation.toValue = @[
        (__bridge id)[UIColor colorWithRed:0.3f green:0.0f blue:0.3f alpha:1.0f].CGColor,
        (__bridge id)[UIColor colorWithRed:0.0f green:0.2f blue:0.4f alpha:1.0f].CGColor,
        (__bridge id)[UIColor colorWithRed:0.4f green:0.3f blue:0.2f alpha:1.0f].CGColor,
        (__bridge id)[UIColor colorWithRed:0.5f green:0.1f blue:0.2f alpha:1.0f].CGColor
    ];
    colorAnimation.duration = 5.0;
    colorAnimation.repeatCount = HUGE_VALF;
    colorAnimation.autoreverses = YES;

    [gradientLayer addAnimation:colorAnimation forKey:@"gradientColorChange"];
    ...
    appVersionLabel.text = @"Version 1.0.0";
...
{
    if ([url.scheme isEqualToString:@"trolltheos"]) {
